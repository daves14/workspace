========================================================================
    KONSOLENANWENDUNG: OpenCLProject_001-Projektübersicht
========================================================================

Diese OpenCLProject_001-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre OpenCLProject_001-Anwendung besteht.


OpenCLProject_001.vcxproj
...
OpenCLProject_001.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen OpenCLProject_001.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.

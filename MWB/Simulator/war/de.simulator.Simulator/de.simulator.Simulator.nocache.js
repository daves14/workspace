...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "de.simulator.Simulator" because\n';
  ...
  $wnd.__gwt_activeModules['de.simulator.Simulator'] = {
    'moduleName' : 'de.simulator.Simulator',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/de.simulator.Simulator.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['de.simulator.Simulator'].superdevmode = true;

  var expectedSuffix = '/de.simulator.Simulator.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + de.simulator.Simulator + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:de.simulator.Simulator';
  var devModeSessionKey = '__gwtDevModeSession:de.simulator.Simulator';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/de.simulator.Simulator/de.simulator.Simulator.nocache.js';
  ...
  $wnd.__gwt_activeModules['de.simulator.Simulator'].canRedirect = true;
  $wnd.__gwt_activeModules['de.simulator.Simulator'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING de.simulator.Simulator';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/de.simulator.Simulator?user.agent=' + ua + '&_callback=' + callback;
